...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var product2 = document.querySelector('#type-2');
  var product3 = document.querySelector('#type-3');
  var product4 = document.querySelector('#type-4');
...
},{"./modules/accordion/init-accordion":3,"./modules/init-rent-slider":4,"./modules/init-sale-slider":5,"./utils/ios-vh-fix":7}],2:[function(require,module,exports){
"use strict";
...
exports.initSaleSlider = void 0;
var sliderSale = document.querySelector('[data-slider="sale-swiper"]');
var initSaleSlider = exports.initSaleSlider = function initSaleSlider() {
  if (sliderSale) {
    // eslint-disable-next-line
